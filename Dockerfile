...
# sudo docker build -t mariner:0.2 ./
# sudo docker run -it --mount type=bind,source=/home/jakestout/,target=/home/mariner/docker mariner:0.2 bash
# 
FROM ubuntu:20.04
...
ENV PATH $INSTALLPATH/Mariner-0.1:$PATH
ENV PATH $INSTALLPATH/Mariner-0.1/firmament:$PATH
ENV PATH $INSTALLPATH/Mariner-0.1/sextant:$PATH
